...
module Rack
  class DevBar
    ...
    def bar
      "<div style='height:24px;width:100%;font-size:12px;font-family:helvetica,arial;background:red;bottom:0;padding-top:4px;font-weight:bold:0;position:fixed;right:0;text-align:center;font-weight:bold;color:white;z-index:999;opacity:0.7;transition:opacity .15s;-webkit-transition:opacity .15s' onmouseover='this.style.opacity=0.1' onmouseout='this.style.opacity=0.7'>#{ Rails.env.upcase } ENVIRONMENT</div>"
    end
  end
end
